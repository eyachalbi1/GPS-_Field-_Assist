...
# MOD 1: Backlog + Raffinement
old1 = r"""\caption{Backlog Sprint 1 - 12/12 elements implementes (100\%)}
\label{tab:backlog}
\end{table}
...
new1 = r"""\caption{Backlog Sprint 1 - 12/12 elements implementes (100\%)}
\label{tab:backlog}
\end{table}
...
if old1 in content:
    ...
    print("MOD 1: Backlog + Raffinement OK")
else:
    print("MOD 1: NOT FOUND")

# MOD 2: Acteurs + Sequence
old2 = r"""\caption{Tableau des acteurs principaux du systeme GPS Field Assist}
\label{tab:actors}
\end{table}

\subsubsection{Diagramme de sequence - Diagnostic sequentiel ET8}"""

new2 = r"""\caption{Tableau des acteurs principaux du systeme GPS Field Assist}
\label{tab:actors}
\end{table}
...
if old2 in content:
    ...
    print("MOD 2: Acteurs + Sequence OK")
else:
    print("MOD 2: NOT FOUND")

# MOD 3: Deroulement
old3 = r"""\textbf{Deroulement du processus :}
...
new3 = r"""\textbf{Deroulement du processus :}
...
if old3 in content:
    ...
    print("MOD 3: Deroulement OK")
else:
    print("MOD 3: NOT FOUND")

# MOD 4: Architecture
old4 = r"""\caption{Architecture globale du systeme - Sprint 1}
\label{fig:architecture-global}
\end{figure}

\textbf{Composants principaux :}"""

new4 = r"""\caption{Architecture globale du systeme - Sprint 1}
\label{fig:architecture-global}
\end{figure}
...
if old4 in content:
    ...
    print("MOD 4: Architecture OK")
else:
    print("MOD 4: NOT FOUND")

# MOD 5: Workflow
old5 = r"""\caption{Workflow sequentiel du diagnostic - Processus avec corrections automatiques}
...
new5 = r"""\caption{Workflow sequentiel du diagnostic - Processus avec corrections automatiques}
\label{fig:workflow-diagnostic}
\end{figure}
...
if old5 in content:
    ...
    print("MOD 5: Workflow OK")
else:
    print("MOD 5: NOT FOUND")

# MOD 6: Tests criteres
old6 = r"""\caption{Criteres d'acceptation du Sprint 1}
\label{tab:criteria}
\end{table}

\subsection{Campagne de tests terrain}"""

new6 = r"""\caption{Criteres d'acceptation du Sprint 1}
\label{tab:criteria}
\end{table}
...
if old6 in content:
    ...
    print("MOD 6: Tests criteres OK")
else:
    print("MOD 6: NOT FOUND")

# MOD 7: Tests par modele
old7 = r"""\caption{Resultats des tests par modele de boitier}
\label{tab:test-results}
\end{table}

\subsection{Tests par module fonctionnel}"""

new7 = r"""\caption{Resultats des tests par modele de boitier}
\label{tab:test-results}
\end{table}
...
if old7 in content:
    ...
    print("MOD 7: Tests par modele OK")
else:
    print("MOD 7: NOT FOUND")
